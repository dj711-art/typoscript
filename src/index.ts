...
// function createShape(kind: "circle"|"square", radius: number): Circle;
function createShape(kind: "circle" | "square" | "triangle", secondArgument: number, thirdArgument?: number): Shape {
  if (kind === "circle") {
    ...
    return { kind: "triangle", base: secondArgument, height: thirdArgument } as Triangle;
  }
...
function printProperties(obj: ShapeWithProperties, getProperty: (propName: string, propValue: any) => string) {
